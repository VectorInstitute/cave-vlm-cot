...
os.environ.setdefault(
    ...
    os.getenv("PHOENIX_COLLECTOR_ENDPOINT", "https://app.phoenix.arize.com/s/CaVe-VLM-CoT"),
)
_api_key = os.environ["PHOENIX_API_KEY"]
if not _api_key:
    raise EnvironmentError("PHOENIX_API_KEY is not set. Export it before running: export PHOENIX_API_KEY=<your-key>")
